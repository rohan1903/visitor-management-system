"""Gender model test. Run from Register_App/: python tests/test_gender.py. Requires genderage.onnx in Register_App/."""
import os
import sys
...
# Load ONNX gender model (from Register_App directory)
